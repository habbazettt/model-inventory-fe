...
export default function ApproverHomePage() {
    ...
    return (
        <main className="flex h-screen overflow-hidden">
            <Sidebar>
                <SidebarItem icon={<Home size={20} />} text="Home" active urlNavigate="/approver/home" />
                <SidebarItem icon={<Bell size={20} />} text={"Notifications"} alert={true} urlNavigate="/approver/notifications" />
                <SidebarItem icon={<FileBox size={20} />} text={"Model Approval"} urlNavigate="/approver/model-approval" />
                <hr className="my-3" />
                <SidebarItem icon={<Settings size={20} />} text={"Settings"} urlNavigate="/approver/settings" />
                <SidebarItem icon={<HelpCircle size={20} />} text={"Help"} urlNavigate="/approver/help" />
            </Sidebar>
