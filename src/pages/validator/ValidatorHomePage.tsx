...
export default function ValidatorHomePage() {
    ...
    return (
        <main className="flex h-screen overflow-hidden">
            <Sidebar>
                <SidebarItem icon={<Home size={20} />} text="Home" active urlNavigate="/validator/home" />
                <SidebarItem icon={<Bell size={20} />} text={"Notifications"} alert={true} urlNavigate="/validator/notifications" />
