...
export default function ValidatorModelDetailsPage() {
                ...
                <div className="h-full flex flex-col p-4 md:p-6 min-h-screen">
                    ...
                    <div className="mb-6">
                        <div className="flex items-center gap-4 mb-4">
                            <button
                                onClick={() => navigate("/validator/model-validation")}
                                className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors"
                            >
                                <ArrowLeft size={20} />
                                <span className="text-sm font-medium">Back to Model Validation</span>
                            </button>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
                                ...
                                <div className="flex justify-end p-6 bg-gray-50">
                                    <Button type="button" onClick={() => navigate(`/validator/model/${selectedModel.id}/results`)}>
                                        Execute Model
                                    </Button>
                                </div>
                            </div>
