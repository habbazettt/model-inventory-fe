import { Bell, Check, HelpCircle, Home, Reply, Settings, Users } from "lucide-react";
import Sidebar, { SidebarItem } from "../../components/Sidebar";
import { useState } from "react";
import ReplyModal from "../../components/modal/ReplyModal";
import { useCheckRole } from "../../utils/checkRole";

export default function SuperuserNotificationsPage() {
    ...
    return (
        <main className="flex h-screen overflow-hidden">
            <Sidebar>
                ...
                <SidebarItem icon={<Bell size={20} />} text={"Notifications"} active alert={true} urlNavigate="/superuser/notifications" />
